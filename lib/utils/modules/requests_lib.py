...
#
def get_working_proxies(list_range=50):
    proxy = Proxy()
    #
    working_proxies = []
    #
...
if __name__ == '__main__':
    ...
    #
    #
    print('=> Get working proxies...')
    working_proxies = get_working_proxies()
    # working_proxies = test_proxies('gr')
    print('=> Done')
    ...
    if (len(working_proxies) != 0):
        ...
        #
        # proxies = {'http': 'http://20.195.17.90:3128',
        #            'https': 'https://20.195.17.90:3128'}
        #
        r = requests.get(
